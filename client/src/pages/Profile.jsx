...
const Profile = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      if (res.status === 200) {
        dispatch(deleteUserSuccess('User has been logged out!'));
        // Optionally perform any cleanup or additional actions upon successful sign-out
      } else {
        dispatch(deleteUserFailure('Failed to sign out user'));
